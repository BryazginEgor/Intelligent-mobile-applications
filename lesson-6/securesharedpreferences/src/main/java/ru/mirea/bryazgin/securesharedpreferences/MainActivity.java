package ru.mirea.bryazgin.securesharedpreferences;
...
import ru.mirea.bryazgin.securesharedpreferences.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    private String fileName = "tolstoy.png";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.editTextTextPersonName.setText(secureSharedPreferences.getString("Lyricist1", "Толстой"));

        File sdCard = Environment.getExternalStorageDirectory();
        File directory = new File (sdCard.getAbsolutePath());
        File file = new File(directory, "tolstoy.png");
    ...
    public void loadButton(View view) throws IOException {
        Bitmap bitmap = BitmapFactory.decodeResource(getResources(), R.raw.tolstoy  );
